...
Route::get('/',[Indexcontroller::class,'index']);
    ...
    Route::get('/Usuario', [App\Http\Controllers\HomeController::class, 'index'])->name('home')->middleware('User');
    ...
    Route::post('Locales/{local}/estado', [LocalController::class,'cancelar'])->name('local.cancelar');
